                                            ...
                                            <td className="px-4 py-3 text-sm relative">
                                                <div className="flex flex-wrap gap-2">
                                                    ...
                                                    {route.stops.length > 4 && (
                                                        <button
                                                            onClick={() => setExpandedRouteId(expandedRouteId === route._id ? null : route._id)}
                                                ...
                                                {expandedRouteId === route._id && (
                                                    <div
                                                        className="absolute top-[150%] right-1/2 ml-3 z-20 transition-all duration-200 ease-out opacity-100 scale-100 animate-popup"
                                                    >
                                                        <div className="w-64 p-3 rounded-lg bg-white dark:bg-gray-900 shadow-xl border dark:border-gray-700">
