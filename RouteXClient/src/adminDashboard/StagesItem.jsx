const iconSet = {
    ...
    cart: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path d="M3 1a1 1 0 000 2h1.22l.305 1.222c.003.014.007.028.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28L5.97 1.757A1 1 0 005 1H3zm13 15.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
        </svg>
    ),
    ...
    return (
        <div className="grid gap-6 mb-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4 overflow-x-auto">
            {items.map((item, index) => (
                ...
                >
                    <div className={`p-3 mr-4 rounded-full ${colorSet[item.color]}`}>
                        {iconSet[item.icon]}
                    </div>
